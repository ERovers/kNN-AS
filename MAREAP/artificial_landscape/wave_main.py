...
kwargs = {
    ...
    'threshold': -75,  # Limits where to compute area covered by agents
    'debug': 1,  # Set to 1 to get plots of the landscape after a certain number of iterations
    'potential_func': wave_split_potential_func,  # Change depending on potential used
...
for i in range(int(sys.argv[1]),trials_per_task):
    run_trial(
        potential=wave_split_potential,  # Change according to desired potential
        ...
        output_dir='testing_wave5',  # Change output directory as needed
